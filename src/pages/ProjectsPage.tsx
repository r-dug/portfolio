...
const PROJECTS: Project[] = [
  {
    ...
    description:
      'End-to-end forecasting system for the Louisville housing market: eight public data sources, a seven-model bake-off (including a pretrained transformer) validated on 21k+ backtested forecasts, and an interactive map projecting appreciation, rents, cap rates, and a composite investment score for all 128 neighborhoods at 1-10 year horizons \u2014 with empirical confidence bands on every projection.',
